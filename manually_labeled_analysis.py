...
for up_ch in [1, 0]:
    labels = [f"03_10_22_02-21-2022_0.7minimum_thresh_denoise_gaussian_blur_0.25diam_ch{up_ch}_upstream", f"03_10_22_02-21-2022_repeat_0.7minimum_thresh_denoise_gaussian_blur_0.25diam_ch{up_ch}_upstream", f"03_10_22_02-20-2022_0.7minimum_thresh_denoise_gaussian_blur_0.25diam_ch{up_ch}_upstream"]
